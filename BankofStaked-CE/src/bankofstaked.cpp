...
private:
  ...
  void received_token(const currency::transfer &t)
  {
    ...
    if (t.to == _self)
    {
      ...
      //ckc
      print(" received token 10");

      // if plan is free, add a Freelock entry
      if(plan->is_free == TRUE)
      {
        //ckc
        print(" received token 11");
